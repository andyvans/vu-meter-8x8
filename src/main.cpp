// Based on https://github.com/s-marley/ESP32_FFT_VU/blob/master/ESP32_FFT_VU/ESP32_FFT_VU.ino
...
#define AMPLITUDE       12000          // Depending on your audio source level, you may need to alter this value. Can be used as a 'sensitivity' control.
